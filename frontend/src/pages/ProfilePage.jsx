                ...
                <div className="bg-base-300 rounded-xl p-6">
                    ...
                    <div className="flex flex-col items-center mt-6 gap-4">
                        <div className="relative">
                           ...
                           <label htmlFor="avatar-upload" className={`absolute bottom-0 right-0 bg-base-content hover:scale-105
                        ...
                        <p className="text-sm text-zinc-400">
                            {isUpdatingProfile ? "Uploading..." : "Click the camera icon to change your profile"}
                        </p>
                    </div>
