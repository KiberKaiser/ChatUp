...
import { Eye, EyeOff, Lock, Mail, MessageSquare, User, Loader, Link as LinkIcon } from "lucide-react"
...
const SignUpPage = () => {
    ...
    const validateForm = () => {
        ...
        if(formData.nickname.trim().length < 3) return toast.error("Nickname must be at least 3 characters")
    ...
    return (
        <div className="min-h-screen grid lg:grid-cols-2">
            <div className="flex flex-col justify-center items-center p-6 sm:p-12">
                <div className="w-full max-w-md space-y-8">
                    ...
                    <div className="flex flex-col items-center gap-2 group">
                        ...
                        <h1 className="text-2xl font-bold mt-2 text-gray-900">Sign Up</h1>
                    ...
                    <div className="form-control">
                        ...
                        <div className="relative">
                            <input type="text" className={'input input-bordered w-full pl-10'}
                            placeholder="john_doe" value={formData.nickname}
                            onChange={(e) => setFormData({...formData, nickname: e.target.value.toLowerCase()})}/>
                            <div className="absolute inset-y-0 left-0 pl-3 flex items-center pointer-events-none">
                                <User className="text-base-content/40"/>
                            </div>
                        </div>
                    ...
                    <div className="text-center">
                        <p className="text-base-content/60">
                          ...
                          <Link to="/login" className="inline-flex items-center gap-2 link link-primary">
            ...
            <AuthImagePattern title="Join to ChatUp!"
             subtitle="Chat up, don't shut up!"/>
       </div>
    )
} 
